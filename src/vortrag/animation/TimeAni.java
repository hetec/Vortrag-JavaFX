...
public class TimeAni extends Application {
...
//You can add a specific action when each frame is started.
        ...
        KeyValue keyColor1 = new KeyValue(circle.fillProperty(), Color.RED);
        KeyValue keyColor2 = new KeyValue(circle.fillProperty(), Color.YELLOW);
